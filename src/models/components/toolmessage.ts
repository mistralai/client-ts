...
/** @internal */
export const ToolMessageRole$inboundSchema: z.ZodNativeEnum<typeof ToolMessageRole> =
    z.nativeEnum(ToolMessageRole);

/** @internal */
export const ToolMessageRole$outboundSchema: z.ZodNativeEnum<typeof ToolMessageRole> =
...
/** @internal */
export const ToolMessage$inboundSchema: z.ZodType<ToolMessage, z.ZodTypeDef, unknown> = z
    .object({
        content: z.string(),
