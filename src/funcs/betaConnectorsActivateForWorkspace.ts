 ...
 */
export function betaConnectorsActivateForWorkspace(
  client: MistralCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ConnectorActivateForWorkspaceV1Request$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/connectors/{connector_id}/workspace/activate")(
    pathParams,
  );
