 ...
 */
export function betaConnectorsCreateCredentials(
  client: MistralCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ConnectorCreateCredentialsV1Request$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "connector_create_credentials_v1",
    oAuth2Scopes: null,
