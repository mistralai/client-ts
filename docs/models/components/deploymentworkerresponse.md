...
| `location`                                                                                    | [components.DeploymentLocation](../../models/components/deploymentlocation.md)                | :heavy_minus_sign:                                                                            | Where the worker is running; null if the worker did not report a location                     |