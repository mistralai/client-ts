...
* [getSignedUploadUrl](#getsigneduploadurl) - Get a signed URL for direct upload to blob storage.
* [ingestFromBlobStorage](#ingestfromblobstorage) - Ingest a document from blob storage of the document library.
...
<!-- UsageSnippet language="typescript" operationID="libraries_documents_get_signed_upload_url_v1" method="get" path="/v1/libraries/{library_id}/documents/signed-upload-url" -->
```typescript
import { Mistral } from "@mistralai/mistralai";
...
async function run() {
  const result = await mistral.beta.libraries.documents.getSignedUploadUrl({
    libraryId: "c77684a7-f47b-4332-8eff-b2461dd4b12d",
    extension: "mp2a",
  });
...
```typescript
import { MistralCore } from "@mistralai/mistralai/core.js";
import { betaLibrariesDocumentsGetSignedUploadUrl } from "@mistralai/mistralai/funcs/betaLibrariesDocumentsGetSignedUploadUrl.js";
...
async function run() {
  const res = await betaLibrariesDocumentsGetSignedUploadUrl(mistral, {
    libraryId: "c77684a7-f47b-4332-8eff-b2461dd4b12d",
    extension: "mp2a",
  });
  if (res.ok) {
    ...
    console.log("betaLibrariesDocumentsGetSignedUploadUrl failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.LibrariesDocumentsGetSignedUploadUrlV1Request](../../models/operations/librariesdocumentsgetsigneduploadurlv1request.md)                                           | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[components.RequestUploadUrlResponse](../../models/components/requestuploadurlresponse.md)\>**
...
## ingestFromBlobStorage

Ingest a document that was uploaded via a signed URL of the document library from blob storage into the library.

### Example Usage

<!-- UsageSnippet language="typescript" operationID="libraries_documents_ingest_from_blob_storage_v1" method="post" path="/v1/libraries/{library_id}/documents/ingest-from-blob-storage" -->
```typescript
import { Mistral } from "@mistralai/mistralai";
...
async function run() {
  const result = await mistral.beta.libraries.documents.ingestFromBlobStorage({
    libraryId: "7a5d7cf9-bfdb-4bd9-95b9-025e0e6338f1",
    ingestFromBlobStorageRequest: {
      filename: "example.file",
      signedUrl: "https://flashy-sticker.info/",
    },
  });
...
```typescript
import { MistralCore } from "@mistralai/mistralai/core.js";
import { betaLibrariesDocumentsIngestFromBlobStorage } from "@mistralai/mistralai/funcs/betaLibrariesDocumentsIngestFromBlobStorage.js";
...
async function run() {
  const res = await betaLibrariesDocumentsIngestFromBlobStorage(mistral, {
    libraryId: "7a5d7cf9-bfdb-4bd9-95b9-025e0e6338f1",
    ingestFromBlobStorageRequest: {
      filename: "example.file",
      signedUrl: "https://flashy-sticker.info/",
  ...
  if (res.ok) {
    ...
    console.log("betaLibrariesDocumentsIngestFromBlobStorage failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.LibrariesDocumentsIngestFromBlobStorageV1Request](../../models/operations/librariesdocumentsingestfromblobstoragev1request.md)                                     | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
