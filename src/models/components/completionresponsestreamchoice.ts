...
/** @internal */
export const CompletionResponseStreamChoiceFinishReason$inboundSchema: z.ZodNativeEnum<
    typeof CompletionResponseStreamChoiceFinishReason
> = z.nativeEnum(CompletionResponseStreamChoiceFinishReason);

/** @internal */
export const CompletionResponseStreamChoiceFinishReason$outboundSchema: z.ZodNativeEnum<
    typeof CompletionResponseStreamChoiceFinishReason
...
export namespace CompletionResponseStreamChoiceFinishReason$ {
    ...
    export const inboundSchema = CompletionResponseStreamChoiceFinishReason$inboundSchema;
    /** @deprecated use `CompletionResponseStreamChoiceFinishReason$outboundSchema` instead. */
    export const outboundSchema = CompletionResponseStreamChoiceFinishReason$outboundSchema;
}
...
> = z
    .object({
        ...
        finishReason: z.nullable(CompletionResponseStreamChoiceFinishReason$outboundSchema),
    })
    .transform((v) => {
        return remap$(v, {
