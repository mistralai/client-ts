 ...
 */
export function betaConnectorsShareToOrganization(
  client: MistralCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ConnectorShareToOrganizationV1Request$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "connector_share_to_organization_v1",
    oAuth2Scopes: null,
