 ...
 */
export function betaLibrariesDocumentsIngestFromBlobStorage(
  client: MistralCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.LibrariesDocumentsIngestFromBlobStorageV1Request$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON("body", payload.IngestFromBlobStorageRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc(
    "/v1/libraries/{library_id}/documents/ingest-from-blob-storage",
  )(pathParams);
  ...
  const context = {
    ...
    operationID: "libraries_documents_ingest_from_blob_storage_v1",
    oAuth2Scopes: null,
