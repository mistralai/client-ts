 ...
 */
export function betaObservabilityLogsList(
  client: MistralCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.GetLogFields,
...
> {
  const path = pathToFunc("/v1/observability/logs/fields")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.GetLogFields$inboundSchema),
    M.jsonErr(
      [400, 404, 408, 409, 422],
