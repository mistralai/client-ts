 ...
 */
export function betaConnectorsListOrganizationCredentials(
  client: MistralCore,
  request: operations.ConnectorListOrganizationCredentialsV1Request,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.CredentialsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ConnectorListOrganizationCredentialsV1Request$outboundSchema
        .parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.CredentialsResponse$inboundSchema),
