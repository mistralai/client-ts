...
| `errors`                                                                 | [components.BatchError](../../models/components/batch-error.md)[]        | :heavy_check_mark:                                                       | N/A                                                                      |
| `outputs`                                                                | Record<string, *any*>[]                                                  | :heavy_minus_sign:                                                       | N/A                                                                      |
| `status`                                                                 | [components.BatchJobStatus](../../models/components/batch-job-status.md) | :heavy_check_mark:                                                       | N/A                                                                      |
