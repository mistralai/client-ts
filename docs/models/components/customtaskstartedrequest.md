...
```typescript
import { CustomTaskStartedRequest } from "@mistralai/mistralai/models/components";

let value: CustomTaskStartedRequest = {
  eventId: "<id>",
...
| `attributes`                                                                                                          | [components.CustomTaskStartedAttributesRequest](../../models/components/customtaskstartedattributesrequest.md)        | :heavy_check_mark:                                                                                                    | Attributes for custom task started events.                                                                            |