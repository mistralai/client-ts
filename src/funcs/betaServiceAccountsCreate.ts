...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.CreateServiceAccountRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "create_service_account_v1_service_accounts_post",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.ServiceAccount$inboundSchema),
