 ...
 */
export function betaObservabilityDatasetsListRecords(
  client: MistralCore,
  request:
  ...
  Result<
    components.ListDatasetRecordsResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListDatasetRecordsResponse$inboundSchema),
    M.jsonErr(
      [400, 404, 408, 409, 422],
