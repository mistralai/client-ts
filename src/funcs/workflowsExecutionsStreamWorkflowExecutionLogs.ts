...
export function workflowsExecutionsStreamWorkflowExecutionLogs(
  ...
  Result<
    EventStream<operations.StreamWorkflowExecutionLogsResponseBody>,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.StreamWorkflowExecutionLogsRequest$outboundSchema.parse(value),
