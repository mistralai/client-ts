 ...
 */
export function betaConnectorsDeactivateForOrganization(
  client: MistralCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ConnectorDeactivateForOrganizationV1Request$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc(
    "/v1/connectors/{connector_id}/organization/deactivate",
  )(pathParams);
