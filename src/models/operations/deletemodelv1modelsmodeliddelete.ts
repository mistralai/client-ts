...
export namespace DeleteModelV1ModelsModelIdDeleteRequest$ {
    ...
    export const inboundSchema = DeleteModelV1ModelsModelIdDeleteRequest$inboundSchema;
    /** @deprecated use `DeleteModelV1ModelsModelIdDeleteRequest$outboundSchema` instead. */
    export const outboundSchema = DeleteModelV1ModelsModelIdDeleteRequest$outboundSchema;
