...
```typescript
import { CustomTaskCompletedRequest } from "@mistralai/mistralai/models/components";

let value: CustomTaskCompletedRequest = {
  eventId: "<id>",
...
| `attributes`                                                                                                          | [components.CustomTaskCompletedAttributesRequest](../../models/components/customtaskcompletedattributesrequest.md)    | :heavy_check_mark:                                                                                                    | Attributes for custom task completed events.                                                                          |