...
/** @internal */
export const AssistantMessageRole$inboundSchema: z.ZodNativeEnum<typeof AssistantMessageRole> =
    z.nativeEnum(AssistantMessageRole);

/** @internal */
export const AssistantMessageRole$outboundSchema: z.ZodNativeEnum<typeof AssistantMessageRole> =
...
/** @internal */
export const AssistantMessage$inboundSchema: z.ZodType<AssistantMessage, z.ZodTypeDef, unknown> = z
    .object({
