...
| `confidenceScores`                                                                                             | [components.OCRPageConfidenceScores](../../models/components/ocrpageconfidencescores.md)                       | :heavy_minus_sign:                                                                                             | Confidence scores for the OCR page (populated when confidence_scores_granularity is set)                       |
| `blocks`                                                                                                       | *components.Block*[]                                                                                           | :heavy_minus_sign:                                                                                             | Paragraph-level bounding boxes for all content blocks in reading order (populated when include_blocks is True) |