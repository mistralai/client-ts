...
```typescript
import { CustomTaskCompletedResponse } from "@mistralai/mistralai/models/components";

let value: CustomTaskCompletedResponse = {
  eventId: "<id>",
...
| `eventType`                                                                                                           | *"CUSTOM_TASK_COMPLETED"*                                                                                             | :heavy_minus_sign:                                                                                                    | Event type discriminator.                                                                                             |
| `attributes`                                                                                                          | [components.CustomTaskCompletedAttributesResponse](../../models/components/customtaskcompletedattributesresponse.md)  | :heavy_check_mark:                                                                                                    | Attributes for custom task completed events.                                                                          |