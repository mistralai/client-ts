...
| `visibility`                                                                                        | [components.ResourceVisibility](../../models/components/resource-visibility.md)                     | :heavy_minus_sign:                                                                                  | N/A                                                                                                 |
...
| `authData`                                                                                          | [components.AuthData](../../models/components/auth-data.md)                                         | :heavy_minus_sign:                                                                                  | Optional additional authentication data for the connector.                                          |
