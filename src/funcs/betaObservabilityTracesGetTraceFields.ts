 ...
 */
export function betaObservabilityTracesGetTraceFields(
  client: MistralCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.GetTraceFields,
...
> {
  const path = pathToFunc("/v1/observability/traces/fields")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.GetTraceFields$inboundSchema),
    M.jsonErr(
      [400, 404, 408, 409, 422],
