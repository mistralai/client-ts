 ...
 */
export function betaConversationsAppendStream(
  client: MistralCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AgentsApiV1ConversationsAppendStreamRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON("body", payload.AppendConversationRequest, {
    explode: true,
  });
