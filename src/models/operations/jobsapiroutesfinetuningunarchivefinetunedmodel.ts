...
/** @internal */
export const JobsApiRoutesFineTuningUnarchiveFineTunedModelRequest$inboundSchema: z.ZodType<
...
/** @internal */
export const JobsApiRoutesFineTuningUnarchiveFineTunedModelRequest$outboundSchema: z.ZodType<
...
export namespace JobsApiRoutesFineTuningUnarchiveFineTunedModelRequest$ {
    ...
    export type Outbound = JobsApiRoutesFineTuningUnarchiveFineTunedModelRequest$Outbound;
}
