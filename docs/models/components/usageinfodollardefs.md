...
```typescript
import { UsageInfoDollarDefs } from "@mistralai/mistralai/models/components";

let value: UsageInfoDollarDefs = {};
```
...
| `requestCount`                                                                           | *number*                                                                                 | :heavy_minus_sign:                                                                       | N/A                                                                                      |
...
| `promptTokenDetails`                                                                     | [components.PromptTokensDetails](../../models/components/prompttokensdetails.md)         | :heavy_minus_sign:                                                                       | N/A                                                                                      |
| `numCachedTokens`                                                                        | *number*                                                                                 | :heavy_minus_sign:                                                                       | N/A                                                                                      |