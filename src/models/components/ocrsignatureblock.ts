...
/** @internal */
export const OCRSignatureBlock$inboundSchema: z.ZodType<
  OCRSignatureBlock,
  unknown
> = z.object({
  top_left_x: z.int(),
...
export function ocrSignatureBlockFromJSON(
  jsonString: string,
): SafeParseResult<OCRSignatureBlock, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => OCRSignatureBlock$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'OCRSignatureBlock' from JSON`,
  );
}
