 ...
 */
export function workflowsGetWorkflowRegistrations(
  client: MistralCore,
  request?:
  ...
  Result<
    components.WorkflowRegistrationListResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.WorkflowRegistrationListResponse$inboundSchema),
