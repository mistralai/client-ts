...
```typescript
import { ActivityTaskRetryingResponse } from "@mistralai/mistralai/models/components";

let value: ActivityTaskRetryingResponse = {
  eventId: "<id>",
...
| `eventType`                                                                                                           | *"ACTIVITY_TASK_RETRYING"*                                                                                            | :heavy_minus_sign:                                                                                                    | Event type discriminator.                                                                                             |
| `attributes`                                                                                                          | [components.ActivityTaskRetryingAttributes](../../models/components/activitytaskretryingattributes.md)                | :heavy_check_mark:                                                                                                    | Attributes for activity task retrying events.                                                                         |