...
```typescript
import { CreateFileResponse } from "@mistralai/mistralai/models/components";
...
| `purpose`                                                               | [components.FilePurpose](../../models/components/file-purpose.md)       | :heavy_check_mark:                                                      | N/A                                                                     |                                                                         |
| `sampleType`                                                            | [components.SampleType](../../models/components/sample-type.md)         | :heavy_check_mark:                                                      | N/A                                                                     |                                                                         |
...
| `visibility`                                                            | [components.FileVisibility](../../models/components/file-visibility.md) | :heavy_minus_sign:                                                      | N/A                                                                     |                                                                         |