...
/** @internal */
export const EventOut$inboundSchema: z.ZodType<EventOut, z.ZodTypeDef, unknown> = z
    .object({
        name: z.string(),
...
/** @internal */
export const EventOut$outboundSchema: z.ZodType<EventOut$Outbound, z.ZodTypeDef, EventOut> = z
    .object({
        name: z.string(),
        data: z.nullable(z.record(z.any())).optional(),
