 ...
 */
export function betaConnectorsUpdateCredentials(
  client: MistralCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ConnectorUpdateCredentialsRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    consumer_scope: encodeSimple("consumer_scope", payload.consumer_scope, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  const path = pathToFunc(
    "/v1/connectors/{connector_id_or_name}/{consumer_scope}/credentials",
  )(pathParams);
  ...
  const context = {
    ...
    operationID: "connector_update_credentials",
    oAuth2Scopes: null,
