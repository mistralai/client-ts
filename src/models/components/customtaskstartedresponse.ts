...
import {
  ...
  CustomTaskStartedAttributesResponse$inboundSchema,
} from "./customtaskstartedattributesresponse.js";
...
/** @internal */
export const CustomTaskStartedResponse$inboundSchema: z.ZodType<
...
export function customTaskStartedResponseFromJSON(
  jsonString: string,
): SafeParseResult<CustomTaskStartedResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CustomTaskStartedResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CustomTaskStartedResponse' from JSON`,
  );
}
