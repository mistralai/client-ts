 ...
 */
export function betaConnectorsUnshareFromOrganization(
  client: MistralCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ConnectorUnshareFromOrganizationV1Request$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/connectors/{connector_id}/organization/share")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "connector_unshare_from_organization_v1",
    oAuth2Scopes: null,
