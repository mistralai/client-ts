 ...
 */
export function betaUsersListWorkspaces(
  client: MistralCore,
  ...
  PageIterator<
    Result<
      operations.UsersApiListWorkspacesResponse,
      | MistralError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UsersApiListWorkspacesRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/users/me/workspaces")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UsersApiListWorkspacesResponse$inboundSchema, {
      key: "Result",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
