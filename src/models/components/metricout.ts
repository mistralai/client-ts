...
/** @internal */
export const MetricOut$inboundSchema: z.ZodType<MetricOut, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const MetricOut$outboundSchema: z.ZodType<MetricOut$Outbound, z.ZodTypeDef, MetricOut> = z
    .object({
