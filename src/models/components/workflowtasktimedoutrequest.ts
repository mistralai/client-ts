...
import {
  ...
  WorkflowTaskTimedOutAttributes$outboundSchema,
 ...
 */
export type WorkflowTaskTimedOutRequest = {
  /**
   ...
   */
  eventType?: "WORKFLOW_TASK_TIMED_OUT" | undefined;
  /**
...
/** @internal */
export type WorkflowTaskTimedOutRequest$Outbound = {
  event_id: string;
  ...
  event_type: "WORKFLOW_TASK_TIMED_OUT";
  attributes: WorkflowTaskTimedOutAttributes$Outbound;
};

/** @internal */
export const WorkflowTaskTimedOutRequest$outboundSchema: z.ZodType<
...
> = z.object({
  ...
  eventType: z.literal("WORKFLOW_TASK_TIMED_OUT").default(
    "WORKFLOW_TASK_TIMED_OUT" as const,
  ),
  attributes: WorkflowTaskTimedOutAttributes$outboundSchema,
}).transform((v) => {
  return remap$(v, {
    eventId: "event_id",
...
export function workflowTaskTimedOutRequestToJSON(
  workflowTaskTimedOutRequest: WorkflowTaskTimedOutRequest,
): string {
  return JSON.stringify(
    WorkflowTaskTimedOutRequest$outboundSchema.parse(
      workflowTaskTimedOutRequest,
    ),
  );
}
