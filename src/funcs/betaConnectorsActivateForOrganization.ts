 ...
 */
export function betaConnectorsActivateForOrganization(
  client: MistralCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ConnectorActivateForOrganizationV1Request$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc(
    "/v1/connectors/{connector_id}/organization/activate",
  )(pathParams);
