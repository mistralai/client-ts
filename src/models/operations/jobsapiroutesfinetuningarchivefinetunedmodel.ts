...
/** @internal */
export const JobsApiRoutesFineTuningArchiveFineTunedModelRequest$inboundSchema: z.ZodType<
...
/** @internal */
export const JobsApiRoutesFineTuningArchiveFineTunedModelRequest$outboundSchema: z.ZodType<
...
export namespace JobsApiRoutesFineTuningArchiveFineTunedModelRequest$ {
    ...
    export const inboundSchema = JobsApiRoutesFineTuningArchiveFineTunedModelRequest$inboundSchema;
    ...
    export type Outbound = JobsApiRoutesFineTuningArchiveFineTunedModelRequest$Outbound;
}
