 ...
 */
export function betaLibrariesDocumentsTextContent(
  client: MistralCore,
  request: operations.V1LibrariesDocumentsGetTextContentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.DocumentTextContent,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V1LibrariesDocumentsGetTextContentRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "v1_libraries_documents_get_text_content",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.DocumentTextContent$inboundSchema),
