 ...
 */
export function betaObservabilitySpansListSpanFields(
  client: MistralCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.GetSpanFields,
...
> {
  const path = pathToFunc("/v1/observability/spans/fields")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.GetSpanFields$inboundSchema),
    M.jsonErr(
      [400, 404, 408, 409, 422],
