 ...
 */
export function betaConnectorsUnshare(
  client: MistralCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ConnectorUnshareV1Request$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/connectors/{connector_id}/share")(pathParams);
