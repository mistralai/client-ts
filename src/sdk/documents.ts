...
export class Documents extends ClientSDK {
   ...
   */
  async list(
    request: operations.V1LibrariesDocumentsListRequest,
   ...
   */
  async upload(
    request: operations.V1LibrariesDocumentsUploadRequest,
    options?: RequestOptions,
   ...
   */
  async get(
    request: operations.V1LibrariesDocumentsGetRequest,
    options?: RequestOptions,
  ): Promise<components.DocumentOut> {
   ...
   */
  async update(
    request: operations.V1LibrariesDocumentsUpdateRequest,
    options?: RequestOptions,
  ): Promise<components.DocumentOut> {
   ...
   */
  async delete(
    request: operations.V1LibrariesDocumentsDeleteRequest,
    options?: RequestOptions,
  ): Promise<void> {
   ...
   */
  async textContent(
    request: operations.V1LibrariesDocumentsGetTextContentRequest,
    options?: RequestOptions,
   ...
   */
  async status(
    request: operations.V1LibrariesDocumentsGetStatusRequest,
    options?: RequestOptions,
   ...
   */
  async getSignedUrl(
    request: operations.V1LibrariesDocumentsGetSignedUrlRequest,
    options?: RequestOptions,
  ): Promise<string> {
  ...
  async extractedTextSignedUrl(
    request: operations.V1LibrariesDocumentsGetExtractedTextSignedUrlRequest,
    options?: RequestOptions,
  ): Promise<string> {
   ...
   */
  async reprocess(
    request: operations.V1LibrariesDocumentsReprocessRequest,
    options?: RequestOptions,
  ): Promise<void> {
