 ...
 */
export function betaObservabilityChatCompletionEventsFetchSimilarEvents(
  client: MistralCore,
  request:
  ...
  Result<
    components.SearchChatCompletionEventsResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.SearchChatCompletionEventsResponse$inboundSchema),
    M.jsonErr(
      [400, 404, 408, 409, 422],
