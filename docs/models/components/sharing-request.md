...
| `level`                                                              | [components.ShareEnum](../../models/components/share-enum.md)        | :heavy_check_mark:                                                   | N/A                                                                  |
| `shareWithUuid`                                                      | *string*                                                             | :heavy_check_mark:                                                   | The id of the entity (user, workspace or organization) to share with |
| `shareWithType`                                                      | [components.EntityType](../../models/components/entity-type.md)      | :heavy_check_mark:                                                   | The type of entity, used to share a library.                         |