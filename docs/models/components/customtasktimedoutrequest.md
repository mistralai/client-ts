...
```typescript
import { CustomTaskTimedOutRequest } from "@mistralai/mistralai/models/components";

let value: CustomTaskTimedOutRequest = {
  eventId: "<id>",
...
| `eventType`                                                                                                           | *"CUSTOM_TASK_TIMED_OUT"*                                                                                             | :heavy_minus_sign:                                                                                                    | Event type discriminator.                                                                                             |
| `attributes`                                                                                                          | [components.CustomTaskTimedOutAttributes](../../models/components/customtasktimedoutattributes.md)                    | :heavy_check_mark:                                                                                                    | Attributes for custom task timed out events.                                                                          |