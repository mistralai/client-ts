 ...
 * CreateSkill
 */
export function betaSkillsCreate(
  client: MistralCore,
  request: components.CreateSkillRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SkillsCreateResponse,
    | MistralError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SkillsCreateResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.SkillsCreateResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
