...
import {
  ...
  ActivityTaskStartedAttributesResponse$inboundSchema,
} from "./activitytaskstartedattributesresponse.js";
...
/** @internal */
export const ActivityTaskStartedResponse$inboundSchema: z.ZodType<
...
> = z.object({
  ...
  event_type: z.literal("ACTIVITY_TASK_STARTED").default(
...
export function activityTaskStartedResponseFromJSON(
  jsonString: string,
): SafeParseResult<ActivityTaskStartedResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ActivityTaskStartedResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ActivityTaskStartedResponse' from JSON`,
  );
}
