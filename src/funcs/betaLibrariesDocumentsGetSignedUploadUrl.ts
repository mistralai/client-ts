 ...
 */
export function betaLibrariesDocumentsGetSignedUploadUrl(
  client: MistralCore,
  request: operations.LibrariesDocumentsGetSignedUploadUrlV1Request,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.RequestUploadUrlResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.LibrariesDocumentsGetSignedUploadUrlV1Request$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc(
    "/v1/libraries/{library_id}/documents/signed-upload-url",
  )(pathParams);
  ...
  const context = {
    ...
    operationID: "libraries_documents_get_signed_upload_url_v1",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.RequestUploadUrlResponse$inboundSchema),
