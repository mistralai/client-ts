 ...
 */
export function betaConnectorsActivateForUser(
  client: MistralCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ConnectorActivateForUserV1Request$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/connectors/{connector_id}/user/activate")(
    pathParams,
  );
