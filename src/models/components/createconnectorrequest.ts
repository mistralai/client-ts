...
export type CreateConnectorRequest = {
   ...
   */
  oauthServerMetadataUrl?: string | null | undefined;
  /**
...
export type CreateConnectorRequest$Outbound = {
  ...
  oauth2_server_metadata?:
    ...
    | null
    | undefined;
  oauth_server_metadata_url?: string | null | undefined;
...
> = z.object({
  ...
  oauth2ServerMetadata: z.nullable(ExtendedOAuthServerMetadata$outboundSchema)
    .optional(),
  oauthServerMetadataUrl: z.nullable(z.string()).optional(),
  ...
  return remap$(v, {
    ...
    oauthServerMetadataUrl: "oauth_server_metadata_url",
