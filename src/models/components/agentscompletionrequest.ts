...
export const AgentsCompletionRequestToolChoice = {
    Auto: "auto",
    None: "none",
    Any: "any",
} as const;
export type AgentsCompletionRequestToolChoice = ClosedEnum<
    typeof AgentsCompletionRequestToolChoice
>;
...
/** @internal */
export const AgentsCompletionRequestToolChoice$inboundSchema: z.ZodNativeEnum<
    typeof AgentsCompletionRequestToolChoice
> = z.nativeEnum(AgentsCompletionRequestToolChoice);

/** @internal */
export const AgentsCompletionRequestToolChoice$outboundSchema: z.ZodNativeEnum<
    typeof AgentsCompletionRequestToolChoice
...
export namespace AgentsCompletionRequestToolChoice$ {
    ...
    export const outboundSchema = AgentsCompletionRequestToolChoice$outboundSchema;
}
...
> = z
    .object({
        ...
        tool_choice: AgentsCompletionRequestToolChoice$inboundSchema.default("auto"),
        agent_id: z.string(),
    })
    .transform((v) => {
        return remap$(v, {
...
> = z
    .object({
        ...
        toolChoice: AgentsCompletionRequestToolChoice$outboundSchema.default("auto"),
        agentId: z.string(),
    })
    .transform((v) => {
        return remap$(v, {
