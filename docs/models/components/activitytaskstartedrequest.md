...
```typescript
import { ActivityTaskStartedRequest } from "@mistralai/mistralai/models/components";

let value: ActivityTaskStartedRequest = {
  eventId: "<id>",
...
| `eventType`                                                                                                           | *"ACTIVITY_TASK_STARTED"*                                                                                             | :heavy_minus_sign:                                                                                                    | Event type discriminator.                                                                                             |
| `attributes`                                                                                                          | [components.ActivityTaskStartedAttributesRequest](../../models/components/activitytaskstartedattributesrequest.md)    | :heavy_check_mark:                                                                                                    | Attributes for activity task started events.                                                                          |