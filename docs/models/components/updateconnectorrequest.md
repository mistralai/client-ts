...
| `protocol`                                                                   | [components.ConnectorProtocol](../../models/components/connectorprotocol.md) | :heavy_minus_sign:                                                           | Protocol of the connector.                                                   |
...
| `authData`                                                                   | [components.AuthData](../../models/components/authdata.md)                   | :heavy_minus_sign:                                                           | New authentication data for your mcp connector.                              |