 ...
 */
export function betaConnectorsDeleteOrganizationCredentials(
  client: MistralCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ConnectorDeleteOrganizationCredentialsV1Request$outboundSchema
        .parse(value),
  ...
  const pathParams = {
    ...
    credentials_name: encodeSimple(
      "credentials_name",
      payload.credentials_name,
      { explode: false, charEncoding: "percent" },
    ),
  };
