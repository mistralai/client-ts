 ...
 */
export function betaConnectorsDeactivateForUser(
  client: MistralCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ConnectorDeactivateForUserV1Request$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/connectors/{connector_id}/user/deactivate")(
    pathParams,
  );
