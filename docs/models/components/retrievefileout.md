...
| `purpose`                                                                                  | [components.RetrieveFileOutPurpose](../../models/components/retrievefileoutpurpose.md)     | :heavy_check_mark:                                                                         | The intended purpose of the uploaded file. Only accepts fine-tuning (`fine-tune`) for now. | fine-tune                                                                                  |
