 ...
 */
export function betaLibrariesDocumentsGetSignedUrl(
  client: MistralCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V1LibrariesDocumentsGetSignedUrlRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "v1_libraries_documents_get_signed_url",
    oAuth2Scopes: [],
