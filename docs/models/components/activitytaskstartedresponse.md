...
```typescript
import { ActivityTaskStartedResponse } from "@mistralai/mistralai/models/components";

let value: ActivityTaskStartedResponse = {
  eventId: "<id>",
...
| `attributes`                                                                                                          | [components.ActivityTaskStartedAttributesResponse](../../models/components/activitytaskstartedattributesresponse.md)  | :heavy_check_mark:                                                                                                    | Attributes for activity task started events.                                                                          |