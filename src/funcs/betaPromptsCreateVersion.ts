 ...
 * CreatePromptVersion
 */
export function betaPromptsCreateVersion(
  client: MistralCore,
  promptId: string,
...
> {
  const input: operations.PromptsCreateVersionRequest = {
    promptId: promptId,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.PromptsCreateVersionRequest$outboundSchema.parse(value),
