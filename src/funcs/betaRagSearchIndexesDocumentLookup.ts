 ...
 */
export function betaRagSearchIndexesDocumentLookup(
  client: MistralCore,
  request:
  ...
  Result<
    components.VespaGetRetrievableResponseRetrievable,
...
> {
  ...
  const path = pathToFunc(
    "/v1/rag/indexes/index/{index_id}/schemas/schema/{schema_id}/retrievables/retrievable/{document_id}",
  )(pathParams);
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["400", "403", "404", "412", "422", "4XX", "500", "5XX"],
  ...
  >(
    M.json(
      200,
      components.VespaGetRetrievableResponseRetrievable$inboundSchema,
    ),
    M.jsonErr(422, errors.HTTPValidationError$inboundSchema),
    M.fail([400, 403, 404, 412, "4XX"]),
    M.fail([500, "5XX"]),
