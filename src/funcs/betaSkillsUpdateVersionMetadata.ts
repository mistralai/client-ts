 ...
 */
export function betaSkillsUpdateVersionMetadata(
  client: MistralCore,
  skillId: string,
  version: number,
...
> {
  const input: operations.SkillsUpdateVersionMetadataRequest = {
    skillId: skillId,
    version: version,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.SkillsUpdateVersionMetadataRequest$outboundSchema.parse(value),
